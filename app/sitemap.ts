...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/investment`, lastModified: now, changeFrequency: "weekly", priority: 0.9 },
    ...
    { url: `${baseUrl}/commercial`,     lastModified: now, changeFrequency: "monthly", priority: 0.7 },
